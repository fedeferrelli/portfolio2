    ...
    <div className="m-auto sm:w-10/12 w-full mb-10 rounded-xs shadow-sm shadow-gray-400 bg-secondary/20 sm:bg-secondary/10">
      ...
      >
        ...
        <div className=" sm:w-full bg-secondary/5  m-auto rounded border border-secondary/20 drop-shadow-[0_0px_15px_rgba(0,0,0,0.5)] h-full">
          ...
          <div className=" sm:hidden w-40 m-auto text-center text-terciary/50 rounded-full px-2 py-1 mb-2 border border-terciary" onClick={()=> setShowDescription (!showDescription)}>{!showDescription ? "ver descripción" : "ver imagen"}</div>
...
>
  {" "}
 <button className="uppercase text-center py-2 sm:py-1 w-full "> {link ? "site" : "apk"}</button>
</a>
...
>
  {" "}
 <button className="uppercase text-center py-2 sm:py-1 w-full ">Code</button>
</a>
