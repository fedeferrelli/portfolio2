...
function ValoresVersusDiferencias() {
  ...
  return (
    <Fade duration="1000" triggerOnce className="w-full">
      <main className="flex flex-col min-h-screen  w-full bg-gray-200 ">
        <section className="bg-alternative p-4 flex  flex-col w-full text-gray-800">
          <Link to="/blog">
            {" "}
          ...
          <h1 className="w-full mt-4  text-2xl sm:leading-tight font-semibold  font-sans text-center">
            Valores vs Referencias en Javascript
          </h1>

          <h2 className="w-full my-1  text-md sm:leading-tight font-normal font-sans text-left max-w-prose">
          ...
          <p className="w-full mt-2  text-md font-thin font-sans text-left max-w-prose">
          ...
          <section className="mt-3">
            ...
            <p className="w-full mt-2 bg-gray-800/5 p-4 rounded-md  font-thin font-sans text-left max-w-prose">
          ...
          <section className="mt-3">
            ...
            <p className="w-full mt-2 bg-white/5 p-4 rounded-md  text-sm font-thin font-sans text-left max-w-prose">
...
<section className="mt-3">
  ...
  <iframe className="m-auto mt-6 w-full sm:w-[560px] sm:h-[315px]" src="https://www.youtube.com/embed/AvkyOrWkuQc" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
