    ...
    <Fade duration="1000" triggerOnce className="w-full pb-16">
      <main className="flex flex-col min-h-screen  w-full">
        <section className="bg-alternative p-4 flex  flex-col w-full text-white">
          ...
          <p className="w-full mt-2  text-secondary text-md font-thin font-sans text-left max-w-prose">
          ...
          <section className="mt-3">
            ...
            <p className="w-full mt-2 bg-white/5 p-4 rounded-md  text-secondary text-sm font-thin font-sans text-left max-w-prose">
