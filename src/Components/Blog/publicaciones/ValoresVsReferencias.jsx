      ...
      <main className="flex flex-col min-h-screen  w-full text-md bg-gray-200 text-left font-sans font-normal text-gray-800">
        <section className="bg-alternative p-4 flex  flex-col w-full ">
          ...
          <p className="mt-2 max-w-prose">
            ...
            <li className="mt-2">Datos Primitivos y</li>
            <li>Objetos.</li>
          </p>
          <p className="mt-2 max-w-prose">
          ...
          <section className="mt-3">
            ...
            <p className="mt-2 bg-white/5 p-4 rounded-md  max-w-prose">
...
<section className="mt-3">
  ...
  <iframe className="m-auto mt-6 w-full h-96" src="https://www.youtube.com/embed/AvkyOrWkuQc" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
