...
function NavSections(navs) {
  ...
  return (
    <section className="flex flex-row sm:h-12 h-14 w-11/12 sm:w-[500px] ml-auto mr-auto fixed z-20 right-0 left-0  bottom-2 sm:bottom-2 border border-terciary/50 rounded-md overflow-hidden sm:shadow-md bg-primary shadow-md shadow-white/10">
